...
const PageTransition = ({ isActive }: PageTransitionProps) => {
  return (
    <div 
    ...
    >
      <div 
        className={`absolute inset-0 bg-black transition-transform duration-1000 ease-[cubic-bezier(0.87,0,0.13,1)] ${
